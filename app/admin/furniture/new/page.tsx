// app/admin/furniture/new/page.tsx
"use client";

import { useState } from "react";
import { useRouter } from "next/navigation";
import { ArrowLeft, Save, Package, Image as ImageIcon, X, Upload } from "lucide-react";
import { createFurniture } from "@/lib/api/furniture";
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                ...
                toast.error(response.message || "Failed to create furniture");
            }
        } catch (error: any) {
        ...
        <div className="space-y-6 p-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-400 mt-1">Add furniture item to exhibition catalog</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl">
                        ...
                        <div className="border-2 border-dashed border-gray-600 rounded-lg p-4 text-center">
                            {imagePreview ? (
                                ...
                                <>
                                    ...
                                    <p className="text-gray-400 mb-2">Click or drag to upload image</p>
                ...
                <div className="flex justify-end gap-4">
                    ...
                    >
                        ...
                        {loading ? "Creating..." : "Create Furniture"}
                    </button>
                </div>
            </form>
        </div>
