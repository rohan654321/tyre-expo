          ...
          <div className="group cursor-pointer min-w-0">
            ...
            <div className="mt-4">
              ...
              <Link href={`/articles/${featuredArticle.slug}`}>
                <h3 className="text-[20px] lg:text-[24px] font-bold text-black mt-2 leading-snug hover:text-[#F08400] transition">
            ...
            >
              ...
              <div>
                ...
                <Link href={`/articles/${article.slug}`}>
                  <h4 className="text-[15px] lg:text-[16px] font-bold text-black mt-1 leading-snug hover:text-[#F08400] transition">
                    {article.title}
                  </h4>
                </Link>
